		...
		try {
			while (true) {
				...
				case 1:
					...
					e.seteDesg(eDesg);
					e.seteSal(eSal);
					int k = new EmployeeService().insertData(e);
					System.out.println("Data inserted Successfully....!");

					break;
				case 2:
					ArrayList<Employee> al = new EmployeeService().readData();
					al.forEach((l) -> {
				...
				case 3:
					...
					e1.seteDesg(Desg);
					e1.seteSal(Sal);
					int k1 = new EmployeeService().updateData(e1);
					if (k1 > 0) {
						System.out.println("Data updated Successfully....!");
					} else {
						System.out.println("empployee id not there .....! ");
					}
				...
				case 4:
					...
					int k2 = new EmployeeService().deleteData(eID);
